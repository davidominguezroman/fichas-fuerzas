...
A esta ecuación la llamamos ***Ley de Hooke***.
...
**8.-** Un muelle de constante elástica $K=20N/m$ tiene suspendida una masa $m=100g$. ¿Cuál será su alargamiento $\Delta x$? Utiliza unidades en el **Sistema Internacional (metros, Newton, kilogramo, etc.)**. Aceleración de la gravedad: $g=9,8 m/s²$.
